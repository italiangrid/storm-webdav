...
public class SaveAuthnAccessDeniedHandler implements AccessDeniedHandler {
  ...
  public SaveAuthnAccessDeniedHandler(
      PrincipalHelper principalHelper, AccessDeniedHandler delegate) {
  ...
  public void handle(
    ...
    request.setAttribute(
        LogbackAccessAuthnInfoFilter.REMOTE_USER_ATTR_NAME, helper.getPrincipalAsString(authn));
